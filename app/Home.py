...
# --- DECISIONFLOW ANNOUNCEMENT ---
st.markdown("---")
st.header("New: Insurance DecisionFlow AI")
st.markdown(
    """
    The original recommender has been upgraded with a **DecisionFlow** layer
    that turns raw scores into decisions.  This new component
    orchestrates the existing hybrid model, enforces business rules,
    assesses risk, generates human explanations and logs every
    recommendation for auditing.  You can explore it in the
    **DecisionFlow AI** page from the sidebar.
    """
)
